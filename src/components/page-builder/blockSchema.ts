...
export const BLOCK_META: BlockMeta[] = [
  ...
  { type: "container", label: "Achtergrondblok", category: "Layout", icon: "Square", defaultProps: { content: "Inhoud van het blok", bgColor: "muted", padding: "large", maxWidth: "none" } },
  { type: "row", label: "Rij met kolommen", category: "Layout", icon: "Columns", defaultProps: { columns: 2, gap: 32, bgColor: "background", padding: "medium", verticalAlign: "stretch", maxWidth: "none", responsive: "auto" } },
